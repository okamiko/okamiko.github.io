function main() {
//Take table inputs and convert them to a number(of type int) because can't have decimals or strings for # of items sold
...
var itemFour  = parseInt(document.getElementById("itemFour").value);
    ...
    //Make sure table inputs are in the range 0-infinity and it is a valid number(not some letters)
